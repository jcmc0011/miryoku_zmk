...
U_NA,           U_NA,         U_NA,         &kp LGUI,        U_LT(U_NAV, SPACE), U_LT(U_MEDIA, TAB), U_LT(U_SYM, RET), U_LT(U_NUM, SPACE), U_LT(U_FUN, BSPC), U_NA,         U_NA,          U_NA

#define MIRYOKU_LAYER_NAV \
U_NP,         U_NP,           U_NP,         U_NP,            U_NP,              U_NP,                U_NP,              U_NP,              U_NP,              U_NP,         U_NP,          U_NP, \
U_NP,         U_BOOT,         U_NP,         U_NP,            &u_to_U_BASE,      U_RDO,               U_PST,             U_CPY,             U_CUT,             U_UND,        U_NP,          U_NP, \
...
U_NP,         U_NP,           U_NP,         U_NP,            U_NP,              U_NP,                U_NP,              U_NP,              U_NP,              U_NP,         U_NP,          U_NP, \
U_NP,         U_BOOT,         U_NP,         U_NP,            &u_to_U_BASE,      U_RGB_TOG,           U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,    U_NP,          U_NP, \
...
U_NP,         U_NP,           U_NP,         U_NP,            U_NP,              U_NP,                U_NP,              U_NP,              U_NP,              U_NP,         U_NP,          U_NP, \
U_NP,         &kp LBKT,       &kp N7,       &kp N8,          &kp N9,            &kp RBKT,            &u_to_U_BASE,      U_NP,              U_NP,              U_BOOT,       U_NP,          U_NP, \
...
U_NP,         U_NP,           U_NP,         U_NP,            U_NP,              U_NP,                U_NP,              U_NP,              U_NP,              U_NP,         U_NP,          U_NP, \
U_NP,         &kp LBRC,       &kp AMPS,     &kp ASTRK,       &kp LPAR,          &kp RBRC,            &u_to_U_BASE,      U_NP,              U_NP,              U_BOOT,       U_NP,          U_NP, \
U_NP,         &kp SQT,        &kp DLLR,     &kp PRCNT,       &kp CARET,         &kp PLUS,            &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,     U_NP,          U_NP, \
U_NP,         &kp TILDE,      &kp EXCL,     &kp AT,          &kp HASH,          &kp PIPE,            &u_to_U_SYM,       U_NP,              &kp RALT,          U_NP,         U_NP,          U_NP, \
U_NA,         U_NA,           U_NA,         &kp LPAR,        &kp RPAR,          &kp UNDER,           U_NP,              U_NP,              U_NP,              U_NA,         U_NA,          U_NA

#define MIRYOKU_LAYER_FUN \
U_NP,         U_NP,           U_NP,         U_NP,            U_NP,              U_NP,                U_NP,              U_NP,              U_NP,              U_NP,         U_NP,          U_NP, \
U_NP,         &kp F12,        &kp F7,       &kp F8,          &kp F9,            &kp PSCRN,           &u_to_U_BASE,      U_NP,              U_NP,              U_BOOT,       U_NP,          U_NP, \
