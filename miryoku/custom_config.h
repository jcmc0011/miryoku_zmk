...
U_NP,         &kp TILDE,    &kp EXCL,       &kp AT,          &kp HASH,          &kp PIPE,            &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,         U_NP,          U_NP, \
U_NA,         U_NA,         U_NA,           &kp LPAR,        &kp RPAR,          &kp UNDER,           U_NA,              U_NA,              U_NP,              U_NP,         U_NA,          U_NA,
